...
public class MainWindow extends FragmentActivity implements OnFancyPlaceSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyFancyPlacesApplication.TMP_IMAGE_FULL_PATH = curAppContext.getExternalCacheDir().getAbsolutePath() + File.separator + MyFancyPlacesApplication.TMP_IMAGE_FILENAME;
